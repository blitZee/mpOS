\section{Realios mašinos modelis}
	...
	\begin{flushleft}
	\includegraphics[scale=0.9]{kita/OS.png}
	\end{flushleft}
	...
	\item 4 - Input. Laukiama įvedimo.
	\item 5 - Output. Norima išvesti informaciją.
	\end{itemize}
	...
	Vortotojo rėžimu programa gali vykti kelios programos vienu metu, po kiekvieno veiksmo taimeris mažinamas ir kai jis pasiekia nulį, toliau procesoriaus darbą nustato Procesų planuotojas. Prieinama atmintis yra tik ta, kurią išskyrė procesorius.
	...
	Kitų blokų struktūra: visi žodžiai skirti duomenims
\clearpage